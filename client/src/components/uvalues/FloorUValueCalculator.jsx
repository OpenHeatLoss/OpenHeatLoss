...
// Component
// ─────────────────────────────────────────────────────────────────────────────
export default function FloorUValueCalculator() {
  ...
  const lambdaIns = INS_LAMBDA[insType];
        ...
        <div>
          ...
          <div style={sectionStyle}>
            ...
            {dimMode === "table" ? (
              ...
              <div>
                <label style={labelStyle}>P/A Ratio (m⁻¹) — enter directly</label>
                <input type="number" style={inputStyle} min={0.1} max={2.0} step={0.01} value={manualPA} onChange={e => setManualPA(e.target.value)} />
                <div style={{ fontSize: 12, color: "#6b7280", marginTop: 6 }}>
                  P/A = exposed perimeter ÷ floor area. Use CIBSE Table 2-46 or calculate manually.
                </div>
              </div>
            )}
          </div>
