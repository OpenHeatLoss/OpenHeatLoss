  ...
  const handleExportPDF = async () => {
    try {
      ...
      const pdfData = {
        ...
        emitterType: emitterType === 'existing_radiators' ? 'Existing radiators' :
                     emitterType === 'upgraded_radiators' ? 'Mostly upgraded radiators' :
                     emitterType === 'mostly_ufh' ? 'Mostly underfloor' : '50% radiators, 50% UFH',
        flowTempBand,
        spf,
        lowEstimate,
        highEstimate,
    ...
    <div className="space-y-6">
      ...
      {showResults && showGraph && (
        <div className="border-2 border-purple-600 rounded-lg p-6 bg-white">
          ...
          <PerformanceGraph data={getGraphData()} currentFlowTemp={flowTempBand} />
        </div>
      )}

      {/* Results Section */}
      {showResults && spaceHeatingDemand > 0 && totalFloorArea > 0 && (
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                ...
                <span className="font-semibold">{spaceHeatingDemand.toFixed(0)} kWh</span>
              </div>
              <div className="flex justify-between p-2 bg-gray-50 rounded">
              ...
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                ...
                <span className="font-semibold">{hotWaterDemand.toFixed(0)} kWh</span>
              </div>
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                <span>Demand supplied by heat pump</span>
                <span className="font-semibold">{hotWaterDemand.toFixed(0)} kWh</span>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                ...
                <span className="font-semibold">{totalFloorArea.toFixed(0)} m²</span>
              </div>
              <div className="col-span-2 flex justify-between p-2 bg-blue-50 rounded border border-blue-300">
                ...
                <span className="font-bold text-lg">{wattsPerM2.toFixed(1)} W/m²</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                ...
                <span className="font-semibold">{heatPumpCapacity.toFixed(1)} kW</span>
              </div>
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                <span>Heat pump type</span>
                <span className="font-semibold">{heatPumpType}</span>
              </div>
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                <span>System provides</span>
                <span className="font-semibold text-right text-xs">
                  {project.mcsSystemProvides === 'space_and_hw' ? 'Space heat and hot water' :
                   project.mcsSystemProvides === 'space_only' ? 'Space heating only' : 'Hybrid'}
                </span>
              </div>
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                ...
                <span className="font-semibold text-right text-xs">
                  {emitterType === 'existing_radiators' ? 'Existing radiators' :
                   emitterType === 'upgraded_radiators' ? 'Mostly upgraded radiators' :
                   emitterType === 'mostly_ufh' ? 'Mostly underfloor' : '50% radiators, 50% UFH'}
                </span>
              </div>
              <div className="flex justify-between p-2 bg-gray-50 rounded">
                ...
                <span className="font-semibold">{flowTempBand}</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div className="p-3 bg-green-50 rounded border border-green-300">
                ...
                <span className="font-bold text-2xl text-green-700">{spf.toFixed(1)}</span>
              </div>
              <div className="col-span-2 p-3 bg-gray-50 rounded">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="font-bold text-lg">{lowEstimate.toFixed(0)} kWh</div>
                  </div>
                  <div className="text-gray-400">to</div>
                  <div>
                    <div className="text-xs text-gray-600">High estimate</div>
                    <div className="font-bold text-lg">{highEstimate.toFixed(0)} kWh</div>
                  </div>
                </div>
