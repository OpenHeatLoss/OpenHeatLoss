...
export default function MCS020SoundCalculator({ project, onUpdate }) {
  ...
  useEffect(() => {
    console.log('MCS020 useEffect triggered');
    console.log('project.mcsSoundAssessments:', project.mcsSoundAssessments);
    console.log('Is array?', Array.isArray(project.mcsSoundAssessments));
    console.log('Length:', project.mcsSoundAssessments?.length);
    
    if (project.mcsSoundAssessments && Array.isArray(project.mcsSoundAssessments) && project.mcsSoundAssessments.length > 0) {
      console.log('Setting assessmentPositions to:', project.mcsSoundAssessments);
      setAssessmentPositions(project.mcsSoundAssessments);
    }
  }, [project.mcsSoundAssessments]);
