#!/usr/bin/env python3
"""
Cancellation Form PDF Generator
Renders company-supplied cancellation form wording as-is, with merge tokens resolved.
No default content is shipped — statutory cancellation form wording (e.g. RECC model)
...
PLACEHOLDER = (
    "Cancellation form wording has not yet been configured. Add your business's "
    "approved cancellation form in Settings → Company Details before "
...
if __name__ == "__main__":
    with open(sys.argv[1], 'r') as f:
        data = json.load(f)
    output_file = sys.argv[2] if len(sys.argv) > 2 else "cancellation_form.pdf"
