...
def create_radiator_schedule_pdf(data, output_filename):
    ...
    sys_rows = [
        ['Flow Temperature', 'Return Temperature', 'Flow/Return \u0394T',
         'Outdoor Design Temp', 'Total Emitter Sizing Load', 'No. Rooms'],
        [
            f"{flow}\u00b0C",
            f"{ret}\u00b0C",
            f"{flow - ret:.1f} K",
    ...
    legend_rows = [[
        ...
        Paragraph(
            ...
            ParagraphStyle('l', parent=styles['Normal'], fontSize=8)),
        Paragraph(
            "Output calculated using n=1.3 exponent at design conditions",
            ParagraphStyle('l', parent=styles['Normal'], fontSize=8)),
    ]]
